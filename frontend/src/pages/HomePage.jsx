...
const HomePage = () => {
    const { categoryFilter, setCategory, categories, products, categoryChipsLoading, productsError, productsLoading, categoriesLoading } = useHomeCatalog();
    return (
        <div className="space-y-4">

            <HomeHero categories={categories} loadingCategories={categoriesLoading} />
            ...
            <section id="catolag" className="scroll-mt-24">
                ...
                ) : productsError ? <PageError message="We couldn't load products. Please try again in a moment." /> : products.length === 0 ? (
